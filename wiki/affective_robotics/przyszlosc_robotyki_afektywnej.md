# Przyszłość robotyki afektywnej
...
- integracja LLM z robotami humanoidalnymi
- neuromorooficzne układy obliczeniowe
- zaawansowane sensory emocjonalne
- regulacje prawne i etyczne
- robotyka afektywna w domu i w szkole

## Modele językowe i roboty humanoidalne

Połączenie modeli językowych (GPT-4, Gemini, LLaMA) z robotami humanoidalnymi tworzy systemy zdolne do prowadzenia naturalnych rozmów, rozumienia kontekstu emocjonalnego i adaptowania zachowania w czasie rzeczywistym. Roboty takie jak **Figure 01** (Figure AI) i **Optimus** (Tesla) już demonstrują tę integrację.

Modele językowe wnoszą:

- naturalne rozumienie i generowanie języka
- wiedzę encyklopedyczną i kontekstualną
...
**Obliczenia neuromoroficzne** (*neuromorphic computing*) to architektura sprzętowa inspirowana strukturą mózgu: zamiast klasycznych procesorów von Neumanna, układy zawierają miliony synaptycznych połączeń i impulsowych neuronów (*spiking neurons*). Procesory takie jak Intel Loihi 2 czy IBM TrueNorth są:

- ekstremalnie energooszczędne (100–1000x mniej energii niż GPU)
- szybkie w przetwarzaniu zdarzeń sensorycznych w czasie rzeczywistym
- zdolne do adaptacji (*on-chip learning*)

W kontekście robotyki afektywnej obliczenia neuromoroficzne umożliwią tworzenie małych, mobilnych robotów z bogatym przetwarzaniem emocji bez konieczności połączenia z chmurą.
...
Rynek domowych robotów afektywnych dynamicznie się rozwija. Prognozy wskazują, że do 2030 roku miliony gospodarstw domowych będzie posiadało roboty towarzyszące pełniące funkcje:

- towarzyskie i emocjonalne (szczególnie dla osób starszych i samotnych)
- edukacyjne (tutoring, wsparcie dzieci z trudnościami w nauce)
- monitorowania zdrowia i wczesnego wykrywania zaburzeń nastroju
- terapeutyczne uzupełniające psychoterapię
...
Analogicznie do uzależnienia od mediów społecznościowych, roboty zaprojektowane pod kątem maksymalizacji zaangażowania mogą prowadzić do patologicznego przywiązania.

### Nierówności technologiczne

Zaawansowane roboty terapeutyczne są drogie. Bez aktywnej polityki publicznej korzyści z robotyki afektywnej mogą być niedostępne dla mniej zamożnych grup społecznych.

## Symbioza człowiek–robot

Wizja długoterminowa zakłada stopniowe zacieranie granicy między człowiekiem a technologią: implanty BCI, roboty noszone (*wearables*), awatary i agenty cyfrowe tworzą nowe formy rozszerzonej tożsamości i współpracy kognitywnej. To wymaga nowych ram etycznych, prawnych i psychologicznych.
