# Roboty społeczne i interakcja HRI

## Definicja robotów społecznych

**Robot społeczny** (*social robot*) to autonomiczny robot zaprojektowany do interakcji i komunikacji z ludźmi w oparciu o zasady rządzące zachowaniem społecznym. W odróżnieniu od robotów przemysłowych działających w izolacji, robot społeczny funkcjonuje w przestrzeni wspólnej z człowiekiem i buduje z nim relację.

Definicja Cynthii Breazeal (2002) podkreśla, że robot społeczny musi:

- rozpoznawać i wyrażać stany emocjonalne
- naśladować i odpowiadać na sygnały społeczne
...
Badacze wyróżniają cztery główne kategorie:

### 1. Roboty towarzyszące

Przeznaczone do budowania długoterminowych relacji z użytkownikiem. Przykłady: **Jibo** (MIT), **Buddy** (Blue Frog Robotics), **PARO** (AIST). Stosowane w opiece nad osobami starszymi, terapii i edukacji.

### 2. Roboty serwisowe

Wspomagają obsługę klienta i dostarczanie informacji. Przykład: **Pepper** (SoftBank) stosowany w centrach handlowych, bankach i szpitalach w ponad 70 krajach.

### 3. Roboty edukacyjne

Wspierają naukę i rozwój dzieci. Przykład: **NAO** (SoftBank) używany w tysiącach szkół na świecie do nauki programowania i wsparcia dzieci z autyzmem.

### 4. Roboty terapeutyczne

Stosowane w leczeniu i rehabilitacji. Przykłady: **KASPAR** (Hertfordshire, terapia autyzmu), **PARO** (terapia demencji).

## Zasady interakcji HRI

**HRI** (*Human-Robot Interaction*) to interdyscyplinarne pole badań obejmujące psychologię, kognitywistykę, inżynierię i projektowanie. Kluczowe zasady naturalnej interakcji człowiek–robot:
...
Kontakt wzrokowy jest kluczowym sygnałem społecznym. Roboty wyposażone w ruchome oczy i zdolne do podążania wzrokiem za rozmówcą są oceniane jako bardziej naturalne i angażujące.

### Synchronia ruchowa

Ludzie nieświadomie synchronizują ruchy z rozmówcą (kameleonizm, efekt kameleona). Roboty wykazujące subtylną synchronię ruchową są odbierane jako bardziej empatyczne.
