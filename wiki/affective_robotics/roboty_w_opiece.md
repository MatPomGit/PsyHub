...
## Zastosowania terapeutyczne robotów

Roboty terapeutyczne stanowią jedną z najbardziej obiecujących i zarazem kontrowersyjnych dziedzin robotyki społecznej. Ich zastosowania obejmują:

- opiekę nad osobami starszymi i chorymi na demencję
- wsparcie dzieci z zaburzeniami ze spektrum autyzmu (ASD)
- rehabilitację ruchową po udarach i urazach
...
Mechanizmy terapeutyczne PARO:

- reaguje na dotyk, głos i kontakt wzrokowy
- wydaje dźwięki przypominające foke
- porusza głową, rzęsami i kończynami
- „zapamiętuje" preferowane zachowania użytkownika

> **Fakt:** Meta-analiza Watt i współpracowników (2021) obejmująca 23 badania kliniczne wykazała, że PARO znacząco redukuje poziom agitacji i lęku u pacjentów z demencją, poprawia nastrój i zmniejsza zapotrzebowanie na leki psychotropowe.
...
Dzieci z zaburzeniami ze spektrum autyzmu (ASD) często wykazują silną preferencję dla interakcji z robotami w porównaniu z ludźmi. Roboty są:

- przewidywalne i spójne (brak zmienności emocji)
- nieinwazyjne społecznie (brak złożonych sygnałów niewerbalnych)
- cierpliwe i nieoceniające
...
Robot **NAO** (SoftBank) jest używany w setkach szkół specjalnych na całym świecie. Jego przewidywalne, powolne ruchy i modulowalny głos sprawiają, że dzieci z ASD są bardziej skłonne do interakcji z nim niż z dorosłymi terapeutami.

> **Fakt:** Przegląd systematyczny Pennisi i współpracowników (2016) obejmujący 15 badań z udziałem dzieci z ASD wykazał, że interakcje z robotami poprawiają inicjowanie kontaktu społecznego, naśladownictwo i uwagę wspólną.

## Roboty w rehabilitacji ruchowej

**HAL** (*Hybrid Assistive Limb*), opracowany przez Yoshiyuki Sankaiego z Uniwersytetu Tsukuba, to egzoszkielet wykrywający sygnały bioelektryczne z mięśni i wspierający ruch. Stosowany w rehabilitacji po udarach, urazach rdzenia kręgowego i chorobach neurodegeneracyjnych.

Roboty rehabilitacyjne umożliwiają:
...
- monitoring stanu zdrowia (ciśnienie, glukoza)
- wspomaganie mobilności
- telekonferencja z rodziną i lekarzami
- stymulacja kognitywna (gry, ćwiczenia pamięci)

## Wyzwania etyczne

### Kwestia decepcji

Czy etyczne jest, by pacjent z demencją wierzył, że PARO jest prawdziwą foką? Niektórzy bioetycycy argumentują, że takie dobrotliwe kłamstwo (*benevolent deception*) jest uzasadnione, gdy przynosi korzyści. Inni uważają, że narusza godność pacjenta.
