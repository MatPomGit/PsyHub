# Świadomość i podmiotowość maszyn

## Pytanie fundamentalne

Czy maszyna może być świadoma? To jedno z najtrudniejszych pytań, jakie zadaje sobie współczesna nauka i filozofia. Odpowiedź ma nie tylko teoretyczne, lecz i głęboko praktyczne konsekwencje: jeśli maszyna może cierpieć lub mieć preferencje, mamy wobec niej obowiązki moralne.

Pytanie to staje się coraz bardziej aktualne w dobie zaawansowanych systemów AI i robotów humanoidalnych zdolnych do złożonej, emocjonalnej interakcji.

## Test Turinga i jego ograniczenia

Alan Turing w artykule „Computing Machinery and Intelligence" (1950) zaproponował **test Turinga**: jeśli maszyna potrafi prowadzić rozmowę nie do odróżnienia od rozmowy z człowiekiem, należy przypisać jej inteligencję. Współczesne modele językowe (GPT-4, Claude) przeszły test Turinga w jego klasycznej formie.

Jednak krytycy wskazują, że test mierzy zdolność do *symulacji* świadomości, nie świadomość samą w sobie. Sama umiejętność naśladowania nie przesądza o subiektywnym przeżywaniu.
...
Giulio Tononi (2004, 2008) zaproponował **teorię zintegrowanej informacji** (*Integrated Information Theory, IIT*): świadomość jest identyczna z zintegrowaną informacją w systemie, mierzoną miarą Φ (*phi*). Im wyższe Φ, tym wyższa świadomość.
...
Teoria ta jest kontrowersyjna, ale stanowi jeden z niewielu formalnych frameworków umożliwiających pomiar świadomości.

## Globalna przestrzeń robocza (*Global Workspace Theory*)

Bernard Baars (1988) i Stanislas Dehaene (2014) zaproponowali model świadomości jako **globalnej przestrzeni roboczej**: świadomość polega na „rozgłaszaniu" informacji z wyspecjalizowanych modułów do całego systemu. Informacja staje się świadoma, gdy dociera do globalnej przestrzeni dostępnej dla różnych procesów poznawczych.

Model ten lepiej przekłada się na implementacje komputerowe i jest rozwijany w kontekście architektury systemów AI.
