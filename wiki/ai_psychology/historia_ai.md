# Historia AI i psychologia

## Narodziny idei myślącej maszyny

Historia sztucznej inteligencji i jej związków z psychologią sięga znacznie głębiej niż pierwsze komputery. Już starożytne mity o Golemie, automatonach Hefajstosa czy mechanicznych sługach opisywały marzenie o stworzeniu istoty obdarzonej rozumem przez człowieka. Jednak naukowe podstawy tej idei pojawiły się dopiero w XX wieku, gdy filozofia umysłu, matematyka i technologia zaczęły tworzyć wspólny fundament.
...
- **Cykl hype'u Gartnera**: nowe technologie przechodzą przez przewidywalne fazy nadmiernych oczekiwań i rozczarowania
- **Błąd planowania**: twórcy AI systematycznie nie doceniali trudności i przeceniali możliwości
- **Efekt Dunninga-Krugera** w zbiorowym wymiarze: wczesne sukcesy budowały nadmierną pewność co do skali możliwości

Psychologia pomogła zrozumieć, dlaczego inwestorzy, badacze i społeczeństwo reagowali tak przewidywalnie na kolejne cykle nadziei i rozczarowania w historii AI.
...
- Modelowanie pamięci i uczenia się
- Symulację rozumowania dedukcyjnego i probabilistycznego
...
Równolegle do symbolicznego nurtu AI rozwijał się nurt połączeniowy (koneksjonistyczny), inspirowany bezpośrednio biologią neuronów. Prace McCullocha i Pittsa (1943), a później Franka Rosenblatta i perceptronu (1958) próbowały odtworzyć architekturę mózgu w postaci sieci matematycznych jednostek.

Ten nurt, przez długi czas w cieniu, przeżył rewolucję w latach 2010., gdy głębokie uczenie maszynowe (deep learning) zaczęło osiągać wyniki niedostępne dla klasycznych algorytmów. Psychologowie i neuronaukowcy obserwowali z fascynacją, jak sieci neuronowe „samodzielnie" wykrywają wzorce zbliżone do tych, które odkrywa ludzki układ wzrokowy.

## Era wielkich modeli językowych i nowe pytania psychologiczne

Pojawienie się modeli językowych takich jak GPT, BERT czy PaLM otworzyło nowy rozdział zarówno w historii AI, jak i w psychologii. Systemy te, trenowane na miliardach tekstów ludzkich, wykazują zadziwiające zdolności do prowadzenia rozmów, generowania treści i rozumienia kontekstu.

Psycholodzy stanęli przed nowymi pytaniami:

1. Czy modele językowe „rozumieją" tekst, czy tylko statystycznie go przewidują?
2. Jak wyjaśnić ich sukcesy w testach teorii umysłu, analogii i rozumowania?
3. Jakie są psychologiczne skutki codziennego korzystania z takich systemów?
4. Czy trening na ludzkich danych sprawia, że AI działa jak „psychologiczne lustro" społeczeństwa?

## Historia obaw: od Frankensteina do AGI

Towarzyszące AI obawy mają długą historię psychologiczną. Mary Shelley w „Frankensteinie" (1818) artykułowała niepokój przed stworzeniem, które wymknie się spod kontroli. Te narracje kulturowe kształtują do dziś stosunek społeczeństwa do AI.

Badania psychologiczne pokazują, że stosunek do AI jest silnie modulowany przez:

- Wcześniejsze doświadczenia z technologią
- Narracje medialne i kulturowe (science-fiction)
