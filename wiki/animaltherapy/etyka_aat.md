...
Rozpoznawanie sygnałów stresu u psa terapeutycznego jest kluczową kompetencją każdego terapeuty AAT. **Sygnały uspokajające** (calming signals, Turid Rugaas) i sygnały stresu to:
...
**Wyraźniejsze:**
- Trzęsienie się jak po wyjściu z wody (bez kontaktu z wodą)
- Natrętne wąchanie, "myślenie nosem"
- Wiercenie się, trudność z zatrzymaniem
- Lizanie ciała (wylizywanie z niepokoju)

**Alarmujące:**
- Uciszenie warg (sondowanie sytuacji)
...
Etyczna AAT wymaga:
- **Certyfikowanego psa:** Ocena temperamentu, szkolenie podstawowe i specjalistyczne, badania weterynaryjne co 12 miesięcy, szczepienia, leczenie profilaktyczne (pasożyty wewnętrzne i zewnętrzne)
- **Certyfikowanego przewodnika/terapeuty:** Szkolenie w zakresie etologii psów, sygnałów dobrostanu i protokołów bezpieczeństwa
- **Limitów czasowych:** Maksymalna długość sesji (zwykle 15–30 min), przerwy między sesjami, limit tygodniowy
- **Środowiska:** Czyste, bezpieczne, z miejscem wycofania dla psa; bezpieczne dla pacjenta

## Konflikt interesów terapeutycznych

AAT może rodzić konflikty między potrzebami pacjenta a dobrem zwierzęcia. Terapeuta musi rozwiązywać je na korzyść zwierzęcia, gdy zagrożone jest jego bezpieczeństwo. Przykłady:
- Pacjent chce przytulać psa silniej niż pies toleruje → interwencja terapeuty
- Pies wykazuje stres podczas konkretnego ćwiczenia → zmiana aktywności
- Pies choruje → sesja odwołana, bez względu na plan terapeutyczny
...
## Zoonoza i bezpieczeństwo zdrowotne

Kontakt ze zwierzętami wiąże się z ryzykiem chorób odzwierzęcych (zoonoz). Odpowiedzialne programy AAT:
- Wymagają aktualnych badań weterynarynych i szczepień
- Protokoły higieny (mycie rąk po kontakcie, zakaz karmienia z ust do ust)
- Wykluczają udział pacjentów z poważną immunosupresją bez oceny lekarskiej
- Regularnie dezynfekują sprzęt (kamizelki, smycze, zabawki)

## Ramy etyczne organizacji
