...
*Drameterapia* (*dramatherapy*) to zamierzone użycie procesów dramatycznych i teatralnych w celach terapeutycznych. Obejmuje psychodramę, socjodramę, narrację, odgrywanie ról i techniki teatralne. Drama dostarcza *bezpiecznego dystansu* (aesthetic distance), który umożliwia pracę z trudnymi treściami przez symboliczną reprezentację.
...
White i Epston (narracja) + drama = reautoryzacja historii życia przez enaktywną narrację (odgrywanie alternatywnych zakończeń). Storytelling, mity i bajki jako terapeutyczne narzędzia.

## Zastosowania kliniczne

Psychodrama stosowana jest w: zaburzeniach traumatycznych, uzależnieniach, zaburzeniach osobowości, depresji i lęku, rehabilitacji psychiatrycznej, pracy z dziećmi i adolescentami.
