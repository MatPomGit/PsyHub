...
## Zegary biologiczne — rytmy dobowe

**Rytmy dobowe (circadian)** to biologiczne oscylacje z ok. 24-godzinnym okresem, obecne we wszystkich żywych organizmach od cyanobakterii po człowieka. Słowo *circadian* pochodzi od łaciny: *circa dies* — "około dnia".

**Suprachiazmatyczne jądro (SCN)** podwzgórza jest głównym pacemaker-em dobowym. Zawiera ok. 20 000 neuronów tworzących autonomiczne oscylatory; każdy neuron sam w sobie pulsuje z ~24-godzinnym rytmem. Synchronizacja z zewnętrzem odbywa się przez **zeitgebers** (synchronizatorzy) — głównie światło, ale też temperatura, czas posiłków, aktywność społeczna.

**Szlak fotyczny:** Specjalne komórki siatkówki (intrinsically photosensitive retinal ganglion cells — ipRGC) zawierające melanopsynę są wrażliwe na krótkie fale światła (niebieski spektr, ~480 nm). Wysyłają sygnały do SCN przez retinohipotalamusowy szlak, synchronizując zegar.
...
Sen nie jest jednorodny — przechodzi przez charakterystyczne fazy w cyklach ok. 90-minutowych.

### NREM (Non-REM) — trzy stadia

**N1 (drzemka):** Lekki sen, łatwe przebudzenie. Wolne fale theta w EEG. Hipnagogiczne omamy (halucynacje zasypywania), szarpnięcia hipniczne (myoclonic jerks).

**N2 (lekki sen):** Ok. 50% łącznego snu. Charakterystyczne wzorce EEG: wrzeciona snu (spindles, 12–15 Hz) — wynik thalamokortalneokorto feedback tłumiącego zewnętrzne bodźce; kompleksy K.

**N3 (głęboki sen wolnofalowy — SWS):** Wolne fale delta (0.5–4 Hz). Najtrudniejsze do przebudzenia. Wydzielanie hormonu wzrostu. Kluczowy dla fizycznej regeneracji, konsolidacji pamięci deklaratywnej, oczyszczania mózgu z metabolitów.

### REM (Rapid Eye Movement)

**Sen REM** jest paradoksalny: EEG aktywny jak w czuwaniu, lecz ciało unieruchomione (paraliż REM — atonia mięśni szkieletowych, zapobiegająca odgrywaniu snów). Intensywne sny. Kluczowy dla: przetwarzania emocji, konsolidacji pamięci proceduralnej i semantycznej, integracji nowych doświadczeń, kreatywności.
...
**Konsolidacja pamięci:** Podczas snu hipokamp "odtwarza" wspomnienia z dnia i transferuje je do długoterminowej pamięci kory. Wrzeciona snu podczas N2 ułatwiają ten transfer. Pozbawienie snu po uczeniu zmniejsza retencję o 20–40%.

**Regulacja emocjonalna:** Sen REM jest "nocną terapią" — Matthew Walker opisuje REM jako "zapamiętywanie emocji bez ładunku emocjonalnego". Reaktywacja wspomnień emocjonalnych podczas REM w środowisku niskiego noradrenaliny (acetylcholinergiczna dominacja) umożliwia rozłączenie emocjonalnego znaczenia od treści wspomnienia.

**Oczyszczanie mózgu (układ glimfatyczny)** — jak opisano powyżej.

**Regulacja metabolizmu:** Niedobór snu zaburza gospodarkę glukozową, zwiększa cortyzol, zwiększa apetyt na wysokokaloryczne jedzenie (wzrost greliny, spadek leptyny).
...
**Opóźniony typ (DSPD):** Zegar przesunięty o 2+ godziny — niemożność zaśnięcia przed 2–4 w nocy. Silna genetyczna predyspozycja, nasilona w adolescencji. Leczenie: chronoterapia, fototerapia poranna, melatonina.

**Jet lag:** Przejściowe rozsynchronizowanie zegara po transmeridianowych podróżach. Adaptacja: 1 dzień/strefę.
