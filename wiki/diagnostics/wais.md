# Skale Wechslera — WAIS, WISC i WPPSI

Skale Wechslera są najpowszechniej stosowanymi narzędziami psychometrycznymi na świecie — mierzą inteligencję przez pryzmat wieloskładnikowego profilu zdolności.

## Historia i twórca

**David Wechsler** (1896–1981) był rumuńsko-amerykańskim psychologiem, który stworzył pierwsze wersje swoich skal w czasie II Wojny Światowej, pracując dla US Army. Wychując się w ubóstwie jako imigrant, świetnie rozumiał, że inteligencja to zdolność do adaptacji, nie jedynie akademicka wiedza.
...
Mierzy: szybkość przetwarzania informacji, uwagę, pracę ręczną. Obniżana przez uszkodzenia istoty białej, depresję, starzenie.
...
- 90–109 = Przeciętna (ok. 50%)
- 80–89 = Poniżej przeciętnej
- 70–79 = Graniczny
- <70 = Niepełnosprawność intelektualna (wymaga potwierdzenia adaptacyjnego)

## Interpretacja profilowa

Równie ważna jak FSIQ jest analiza **profilu indeksów**. Znaczna dysproporcja między VCI a PRI (>15–23 pkt) sugeruje specyficzne uwarunkowania (np. dysleksja, uszkodzenie jednostronne, wzorce neurodywergencji).

> **Przykład kliniczny:** Dziecko z ADHD typowo wykazuje obniżone WMI i PSI przy zachowanych VCI i PRI — co odzwierciedla deficyty uwagi i przetwarzania, a nie niższą inteligencję ogólną. Interpretacja FSIQ bez profilu może prowadzić do błędnych wniosków.

## Efekt Flynna

**Efekt Flynna** (James Flynn, 1984) to zjawisko wzrostu wyników IQ w populacji — średnio ok. 3 punktów na dekadę przez większą część XX wieku. Powody: lepsza edukacja, poprawa odżywienia, bardziej abstrakcyjne środowisko, redukcja chorób.

Konsekwencja: normy muszą być regularnie aktualizowane (renormalizacja). Stosowanie przestarzałych norm **zawyża** wyniki IQ — ważne dla klinicznych decyzji (np. diagnoza niepełnosprawności intelektualnej).

W ostatnich dekadach efekt Flynna zatrzymał się lub odwrócił w niektórych krajach — co jest przedmiotem badań.

## WAIS a ocena neurologiczna

**Wskaźniki Wrażliwości Neurologicznej:**

*Discrepancy analysis:* Znaczna rozbieżność między VCI a PRI może wskazywać na różne uszkodzenia półkulowe (lewostronne → obniżenie VCI; prawostronne → obniżenie PRI).

*Digit Span* jest jednym z najwrażliwszych podtestów na uszkodzenia czołowe i ogólne upośledzenie.
...
**Bias kulturowy:** WAIS VCI jest silnie uwarunkowany kulturowo i edukacyjnie — może systematycznie zaniżać wyniki osób z mniejszości etnicznych, imigrantów, osób o niskim statusie ekonomicznym. PRI jest mniej kulturowo zależny, lecz wciąż niezupełnie wolny.
