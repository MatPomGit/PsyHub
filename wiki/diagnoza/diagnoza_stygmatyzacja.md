...
## Czym jest stygmatyzacja w kontekście diagnozy?
...
| Rodzaj | Opis |
|---|---|
| **Społeczna** | Negatywne postawy otoczenia wobec osoby z diagnozą |
| **Strukturalna** | Instytucjonalne bariery: prawo, ubezpieczenia, rynek pracy |
| **Autostygmatyzacja (self-stigma)** | Internalizacja negatywnych przekonań przez osobę z diagnozą |
| **Przez asocjację** | Stygmatyzacja rodziny i bliskich osoby z diagnozą |
| **Wynikająca z ujawnienia** | Konsekwencje ujawnienia diagnozy środowisku |
...
- Nadmiernego identyfikowania się z diagnozą kosztem własnej tożsamości

### Konsekwencje społeczne i zawodowe

- Dyskryminacja na rynku pracy
- Trudności w relacjach interpersonalnych (ukrywanie diagnozy, izolacja)
- Ograniczony dostęp do ubezpieczenia zdrowotnego i świadczeń
- Stygmatyzacja w instytucjach (szpital, szkoła, system prawny)

### Opóźnienie poszukiwania pomocy

Strach przed etykietą diagnostyczną jest jedną z głównych barier w szukaniu pomocy psychologicznej. Szacuje się, że średni czas między pojawieniem się objawów a zgłoszeniem do specjalisty wynosi w Polsce 7–10 lat dla zaburzeń psychicznych.
...
## Odpowiedzialna komunikacja diagnozy
...
- Psychoedukacja o diagnozie
- Praca nad autostygmatyzacją w terapii (CBT, ACT)
- Budowanie tożsamości opartej na wartościach, nie na etykiecie
- Grupy wsparcia i kontakt z innymi osobami z podobnym doświadczeniem
...
- Unikanie nadmiernej psychiatryzacji normalnych doświadczeń (*medykalizacja*)
- Krytyczna refleksja nad kategoriami diagnostycznymi (DSM, ICD) jako konstruktami społecznymi
- Wzmacnianie głosu użytkowników systemu zdrowia psychicznego w polityce zdrowotnej

---

## Krytyczna perspektywa na diagnozę psychiatryczną

### Konstruktywizm i antipsychiatria

Thomas Szasz (1961), R. D. Laing i inni krytykowali diagnozę psychiatryczną jako narzędzie kontroli społecznej. Choć ich skrajne tezy są kontrowersyjne, wskazali na realne ryzyko:
- Pathologizacji normalnych reakcji (np. smutek po stracie = depresja)
- Kulturowych uprzedzeń w systemach klasyfikacyjnych
- Władzy asymetrycznej między psychiatrą a pacjentem
