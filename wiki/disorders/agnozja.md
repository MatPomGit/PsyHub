...
**Agnozja** (gr. *a-* brak + *gnosis* wiedza) to niezdolność do rozpoznawania i identyfikowania obiektów, twarzy, dźwięków lub innych bodźców *mimo zachowanej sprawności narządu zmysłu*. Termin wprowadził Sigmund Freud w 1891 roku.
...
Rozumienie agnozji wymaga znajomości organizacji kory wzrokowej:

**Szlak brzuszny (ventral stream — "co?"):** V1 → V2 → V4 → dolna kora skroniowa (IT) — odpowiada za identyfikację i rozpoznawanie obiektów, twarzy, kolorów, form.

**Szlak grzbietowy (dorsal stream — "gdzie?/jak?"):** V1 → V2 → V3 → kora ciemieniowa — przetwarzanie lokalizacji przestrzennej, sterowanie ruchem.

### Agnozja aperceptywna

Uszkodzenie wczesnych etapów przetwarzania wzrokowego (wtórna kora wzrokowa, obszary V2-V4). Pacjent nie potrafi nawet skopiować rysunku, nie rozpoznaje podstawowych form geometrycznych — przetwarzanie percepcyjne jest zaburzone u podstaw.

### Agnozja asocjacyjna

Percepcja jest zachowana (pacjent kopiuje rysunki poprawnie), lecz zerwane jest skojarzenie percepuowanego obrazu z wiedzą semantyczną o obiekcie. Pacjent widzi "coś okrągłego, czerwonego, z ogonkiem" — lecz nie rozpoznaje, że to jabłko. Wywiad i dotyk natychmiast ujawniają, co to jest.
...
**Achromopsia/achromatopsia** — niezdolność rozpoznawania kolorów (uszkodzenie V4, area V8). Pacjent widzi świat w odcieniach szarości.

**Agnozja przestrzenna** — zaburzenia percepcji przestrzennej i odległości (uszkodzenia szlaku grzbietowego).

**Symultagnozja** — niemożność widzenia więcej niż jednego obiektu jednocześnie. Część **triady Balinta**: symultagnozja + ataksja wzrokowa (trudności z sięganiem pod kontrolą wzroku) + apraksja oczu (trudności z celowym kierowaniem wzroku). Wynik obustronnych uszkodzeń ciemieniowych.
...
- Kopiowanie rysunków;
- Opis wizualnych cech obiektów (kształt, kolor);
- Identyfikacja przez inne modalności zmysłowe.
