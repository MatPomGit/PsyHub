...
### Kryterium A: Deficyty społeczno-komunikacyjne

1. Deficyty w wzajemności społeczno-emocjonalnej (trudności z inicjowaniem interakcji, "odbijaniem piłeczki" w rozmowie);
2. Deficyty w niewerbalnej komunikacji (kontakt wzrokowy, gesty, mimika);
3. Deficyty w rozwijaniu, utrzymywaniu i rozumieniu relacji.

### Kryterium B: Powtarzalne wzorce zachowań i zainteresowań

1. Stereotypowe lub powtarzalne ruchy, mowa lub użycie obiektów (stimming, echolalia);
2. Naleganie na niezmienność, niereagowanie na zmiany, rytuały;
3. Wysoce ograniczone, fiksowane zainteresowania o niezwykłej intensywności;
4. Nadwrażliwość lub niedowrażliwość sensoryczna.

## Neurobiologia ASD

**Genetyka:** Heritabilność szacowana na 64–91%. Tysiące rzadkich i częstych wariantów. Wiele genów kandydujących (SHANK3, NRXN1, CNTN, PTEN) dotyczy synaptogenezy i organizacji obwodów neuronalnych. Nowe mutacje de novo odpowiadają za znaczącą część przypadków.

**Neuroobrazowanie:** Nadmierna połączoność lokalna (local over-connectivity) przy jednoczesnej niedostatecznej połączoności długozasięgowej. Zmniejszona aktywacja węzłów sieci teorii umysłu (mPFC, TPJ). Odmienne wzorce aktywacji w obszarach przetwarzania twarzy (FFA).
