...
Klasyczne i współczesne wyjaśnienia powstawania, struktury i funkcji emocji.
...
Stanley Schachter i Jerome Singer (1962): emocja = niespecyficzne **pobudzenie fizjologiczne** + **atrybucja poznawcza** (etykieta). Eksperyment z adrenaliną pokazał, że to samo pobudzenie może być odczuwane jako radość lub gniew zależnie od kontekstu społecznego. Teoria podkreśla rolę interpretacji.
...
Paul Ekman (1972) na podstawie badań transkultowych wyróżnił **6 podstawowych emocji** z universalnymi wyrazami twarzy: strach, gniew, smutek, radość, wstręt, zaskoczenie. Badania FACS (Facial Action Coding System) umożliwiły precyzyjny pomiar ekspresji twarzy. Późniejsze prace Ekmana rozszerzyły listę do 17 emocji.
