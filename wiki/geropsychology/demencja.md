...
Otępienie nie jest normalnym efektem starzenia się, lecz chorobą lub skutkiem innych procesów patologicznych. Kryteria diagnostyczne (ICD-11, DSM-5) wymagają:

- istotnego pogorszenia przynajmniej jednej domeny poznawczej (pamięć, uwaga, funkcje wykonawcze, mowa, percepcja wzrokowo-przestrzenna)
- obniżenia sprawności funkcjonalnej w porównaniu z wcześniejszym poziomem
- wpływu na codzienne życie, pracę lub relacje społeczne

Dane epidemiologiczne:

- Na świecie z demencją żyje ok. **55 milionów** osób (WHO, 2023)
- Co roku przybywa ok. 10 milionów nowych przypadków
- Częstość podwaja się co 5 lat: ok. 5% po 65. r.ż., ponad 30% po 85. r.ż.
- W Polsce szacuje się ok. **500 000** chorych, z czego większość bez rozpoznania

> **Kluczowy fakt:** Demencja jest szóstą przyczyną zgonów na świecie i jedną z głównych przyczyn niepełnosprawności i zależności od opiekunów wśród osób starszych. Koszty opieki przewyższają łączne koszty leczenia nowotworów i chorób sercowo-naczyniowych.

## Klasyfikacja i typy demencji

### Choroba Alzheimera (60–70% przypadków)
Najczęstsza forma demencji neurodegeneracyjnej:

- Patologia: odkładanie się blaszek amyloidowych (Aβ) i splotów neurofibrylarnych (tau) w mózgu
- Przebieg: podstępny początek, powolna progresja przez 8–12 lat
- Dominujące objawy: zaburzenia pamięci epizodycznej, dezorientacja, afazja, apraksja, agnostyzja
- Fazy: łagodna (zaburzenia pamięci, dezorientacja), umiarkowana (zaburzenia zachowania, zależność od opieki), ciężka (brak mowy, całkowita zależność)

### Demencja naczyniowa (15–20% przypadków)
Drugi co do częstości typ:

- Mechanizm: niedokrwienie lub mikrokrwawienia mózgowe uszkadzają tkanki nerwowe
- Przebieg: często skokowy, z plateau i nagłymi pogorszeniami po incydentach naczyniowych
- Czynniki ryzyka: nadciśnienie, cukrzyca, migotanie przedsionków, palenie tytoniu
- Objawy: spowolnienie psychoruchowe, zaburzenia funkcji wykonawczych, zmienność nastroju
...
- Obiektywne zaburzenia poznawcze, ale bez istotnego wpływu na codzienne funkcjonowanie
- Ryzyko konwersji do demencji: ok. 10–15% rocznie (vs. 1–2% u osób bez MCI)
- Ważny etap dla interwencji prewencyjnych

## Diagnoza neuropsychologiczna

Ocena neuropsychologiczna jest kluczowa w procesie diagnostycznym. Typowe narzędzia:
...
| ADL/IADL | Codzienne czynności | Stopień zależności |
...
Badania sugerują, że ok. 40% przypadków demencji jest potencjalnie zapobiegalnych poprzez modyfikację czynników ryzyka (Livingston i wsp., 2020):

| Czynnik ryzyka | Szacunkowy udział |
|---|---|
| Niski poziom wykształcenia | 7% |
| Utrata słuchu | 8% |
