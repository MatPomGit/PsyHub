...
*Osobowość* to relatywnie trwałe wzorce myślenia, odczuwania i zachowania, które odróżniają jednostkę od innych. Teorie osobowości różnią się w kwestii, czy osobowość jest wyuczonym wzorcem (behawioryzm), konfiguracją cech biologicznych czy strukturą typów.
...
Model **PEN** Eysencka (Psychotyczność, Ekstrawersja, Neurotyczność), teoria typów **MBTI** (popularna, lecz słabo walidowana empirycznie), biopsychospołeczny model Cloningera (temperament + charakter). Psychoanalityczne teorie osobowości kładą nacisk na nieświadome struktury (id, ego, superego, mechanizmy obronne).
