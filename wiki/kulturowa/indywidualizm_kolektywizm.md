...
Spośród wszystkich wymiarów różnicujących kultury **indywidualizm–kolektywizm** jest najszerzej badany i najlepiej udokumentowany empirycznie. Opisuje on, w jakim stopniu dana kultura kładzie nacisk na autonomię, niezależność i cele osobiste jednostki (biegun indywidualistyczny) versus przynależność do grupy, zharmonizowanie z innymi i cele kolektywne (biegun kolektywistyczny).

---

## Wymiary kulturowe Hofstede

Geert Hofstede przeprowadził w latach 1967–1973 zakrojone na szeroką skalę badania pracowników IBM w ponad 70 krajach. Na ich podstawie wyróżnił początkowo cztery wymiary kulturowe, a następnie rozszerzył model do sześciu:

| Wymiar | Opis |
|---|---|
| **Indywidualizm vs. Kolektywizm (IDV)** | stopień, w jakim jednostka jest niezależna od grupy |
| Dystans władzy (PDI) | akceptacja nierówności hierarchicznych |
| Unikanie niepewności (UAI) | tolerancja na wieloznaczność i ryzyko |
| Męskość vs. Kobiecość (MAS) | orientacja na osiągnięcia vs. jakość życia |
...
## Niezależne i współzależne konstruowanie Ja

Hazel Markus i Shinobu Kitayama (1991) połączyli wymiar indywidualizm–kolektywizm z koncepcją Ja (*self-construal*):

| Cecha | **Niezależne Ja** (*independent*) | **Współzależne Ja** (*interdependent*) |
|---|---|---|
| Granice Ja | wyraźne, stabilne | płynne, zmienne w zależności od relacji |
| Ważne atrybuty | cechy wewnętrzne, zdolności, opinie | role, relacje, przynależności grupowe |
| Zadania | bycie unikalnym, wyrażanie siebie | przynależenie, dopasowanie do innych |
| Podstawa samooceny | spełnienie osobistych standardów | ocena grupy i wypełnianie ról |
| Typowy kontekst | kultury zachodnie | kultury Azji Wschodniej, Afryki, Ameryki Łacińskiej |

---

## Konsekwencje dla poznania, emocji i motywacji
...
| Aspekt | Kultury indywidualistyczne | Kultury kolektywistyczne |
|---|---|---|
| Źródła stresu | zagrożenie autonomii, niespełnienie osobistych celów | dysonans z normami grupy, utrata twarzy (*face*) |
| Style radzenia sobie | radzenie sobie skoncentrowane na problemie | radzenie sobie przez poszukiwanie wsparcia społecznego |
| Ekspresja distressu | eksternalizacja objawów, afekty negatywne | somatyzacja, objawy fizyczne |
| Ryzyko zaburzeń | wyższe wskaźniki depresji indywidualnej, zaburzeń lękowych | wyższe wskaźniki somatoformicznych i relacyjnych form dystressu |
