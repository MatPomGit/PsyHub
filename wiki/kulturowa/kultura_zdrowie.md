...
## Kulturowe syndromy (*culture-bound syndromes*)

Kulturowe syndromy to wzorce doświadczeń i zachowań, które w danej kulturze są uznawane za zaburzenie, lecz nie pasują bezpośrednio do kategorii diagnostycznych psychiatrii zachodniej lub przyjmują w niej zupełnie inną postać.

| Syndrom | Kultura | Obraz kliniczny |
|---|---|---|
...
DSM-5 (APA, 2013) odchodzi od kategorii „culture-bound syndromes" na rzecz **trzech pojęć**: kulturowe syndromy (*cultural syndromes*), kulturowe idiomy distressu (*cultural idioms of distress*) i kulturowe etiologie (*cultural explanations*).
...
## Nierówności w diagnozie i leczeniu

Badania epidemiologiczne wskazują na systematyczne różnice w diagnozie i dostępie do leczenia wzdłuż linii kulturowych i rasowych:

| Problem | Dane |
|---|---|
| **Naddiagnoza schizofrenii** u Afroamerykanów | 3–4× wyższy wskaźnik diagnoz schizofrenii niż u białych Amerykanów przy podobnej symptomatologii (Metzl, 2009) |
| **Niedobór diagnoz depresji** w grupach azjatyckich | somatyzacja maskuje depresję; rzadziej kierowani do psychiatry |
| **Bariery językowe** | terapia prowadzona w L2 redukuje głębokość emocjonalną i skuteczność interwencji |
| **Stygmat kulturowy** | w wielu kulturach szukanie pomocy psychologicznej jest stygmatyzowane jako słabość lub szaleństwo |
| **Nieufność do systemu** | historyczne nadużycia (np. Tuskegee, przymusowe psychiatryzacje) generują nieufność do instytucji medycznych w niektórych grupach |

---

## Kulturowo adaptowana psychoterapia

Metaanalizy (Benish i in., 2011; Smith i in., 2011) wskazują, że **psychoterapia kulturowo adaptowana** jest skuteczniejsza niż standardowe protokoły w pracy z mniejszościami kulturowymi.

### Poziomy adaptacji (model Bernal i in., 1995)

| Wymiar | Przykładowa adaptacja |
|---|---|
| **Język** | Terapia w ojczystym języku klienta |
| **Osoby** (*persons*) | Dopasowanie terapeuty kulturowo lub rasowo |
| **Metafory** | Użycie lokalnych idiomów i pojęć |
| **Treść** (*content*) | Włączenie wartości kulturowych (familia, respeto) |
| **Koncepcja zaburzenia** | Uwzględnienie kulturowych modeli etiologii |
| **Cele** | Cele terapii zgodne z rolami i wartościami kulturowymi |
| **Metody** | Struktury rodzinne i społecznościowe jako zasoby terapeutyczne |
| **Kontekst** | Uwzględnienie historii migracji, dyskryminacji, traum grupowych |

---

## Stres akulturacyjny

Akulturacja to proces zmian wynikający z kontaktu dwóch kultur. John Berry (1997) wyróżnił cztery strategie:

| Strategia | Opis | Dobrostan |
|---|---|---|
| **Integracja** | Utrzymanie kultury pierwotnej + uczestnictwo w kulturze przyjmującej | najlepszy |
| **Asymilacja** | Porzucenie kultury pierwotnej na rzecz nowej | umiarkowany |
| **Separacja** | Zachowanie kultury pierwotnej, odrzucenie nowej | zmienny |
| **Marginalizacja** | Utrata obu kultur | najgorszy |
...
| Obszar | Implikacja kliniczna |
|---|---|
| Kulturowe syndromy | Diagnoza wymaga znajomości lokalnych kategorii zaburzeń |
| Idiomy distressu | Nie mylić z somatyzacją bez uwzględnienia kulturowego języka |
| Formularz kulturowy DSM-5 | Stosować jako standard oceny kulturowej |
| Nierówności w diagnozowaniu | Świadomość własnych uprzedzeń kulturowych i systemowych |
...
- Bernal, G., Bonilla, J., & Bellido, C. (1995). Ecological validity and cultural sensitivity for outcome research. *Journal of Abnormal Child Psychology, 23*(1), 67–82.
