...
Przekształcanie wyników surowych na wyniki standardowe umożliwiające interpretację względem populacji.
...
**Wyniki z** (z-scores) to podstawowa transformacja liniowa: *z = (X – M) / SD*. Wynik z = 0 oznacza przeciętną, z = +1 to jeden odchylenie standardowe powyżej średniej. Skala jest wrażliwa na ujemne wartości i ułamki dziesiętne, co utrudnia komunikację z niespecjalistami.

**Wyniki T** przekształcają z-scores na skalę o średniej 50 i SD = 10: *T = 50 + 10z*. Używane w testach osobowości (MMPI) i neuropsychologicznych. Łatwe do interpretacji: T > 65 (1,5 SD powyżej średniej) sugeruje kliniczny poziom nasilenia.
...
W neuropsychologii normy często stratyfikuje się ze względu na **wiek** (wydajność poznawcza zmienia się przez całe życie) i **wykształcenie** (wyższe wykształcenie wiąże się z wyższymi wynikami w wielu testach). Brak uwzględnienia tych zmiennych prowadzi do fałszywie dodatnich diagnoz deficytów.
