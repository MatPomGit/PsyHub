...
### Eksperymenty Seligmana i Maidera (1967)
...
Osoby różnią się w sposobie wyjaśniania negatywnych zdarzeń na trzech wymiarach:
...
Osoby z **pesymistycznym stylem atrybucji** (*pessimistic explanatory style*) tendencyjnie wyjaśniają negatywne zdarzenia jako:

- **wewnętrzne** (własna wina),
...
Peterson i Seligman (1984) rozwinęli model o wymiar **beznadziejności** (*hopelessness*): przekonanie, że pożądane rezultaty nie nastąpią i nic nie można z tym zrobić. Beznadziejność jest bezpośrednim predyktorem depresji i zachowań suicydalnych.

## Wyuczona bezradność a depresja

### Model depresji z bezradności

Seligman (1975) zaproponował, że wyuczona bezradność jest modelem **depresji reaktywnej**. Analogie między nimi:
...
Alloy i Abramson (1988) wyodrębnili **podtyp depresji z beznadziejności** (*hopelessness depression*) jako specyficzny syndrom wynikający z pesymistycznego stylu atrybucji w obliczu stresujących wydarzeń. Ten podtyp wyróżnia się:

- przede wszystkim pasywnością i retardacją (a nie agitacją);
- dominującym doświadczeniem beznadziejności;
- brakiem poczucia sensu działania;
- podatnością na indukcję przez negatywne zdarzenia życiowe.

### Związek z dysforią i lękiem

Wyuczona bezradność koreluje nie tylko z depresją, ale też z **lękiem uogólnionym**: w wczesnej fazie ekspozycji na niekontrolowane bodźce organizm reaguje lękiem i agitacją; bezradność pojawia się, gdy lęk „wyczerpie się" wobec braku skutecznych działań. Ten mechanizm wyjaśnia częstą komorbidność depresji i zaburzeń lękowych.

## Neurobiologiczne podstawy

### Serotoninowy mechanizm bezradności

Klasyczne badania neurobiologiczne wskazują, że:

- Nieuciekające szczury mają **obniżony poziom serotoniny** w korze czołowej i limbicznej;
- Zwiększona aktywność jądra grzbietowego szwu (*dorsal raphe nucleus*, DRN) wiąże się z zahamowaniem działania (pasywność);
- **SSRI** (selektywne inhibitory wychwytu zwrotnego serotoniny) blokują powstawanie bezradności w modelach zwierzęcych.

### Oś HPA i kortyzol

Nieukontrolowany stres prowadzi do chronicznego podwyższenia kortyzolu, który:

- uszkadza hipokamp (zaburzenia pamięci, uczenia się);
- osłabia neuroplastyczność (obniżona ekspresja BDNF);
- tworzy pętlę nasilającą bezradność.
...
Wyuczona bezradność wiąże się z **dysregulacją układu dopaminergicznego**:

- obniżona reaktywność na nagrody (anhedonia);
- zaburzone uczenie się instrumentalne;
- ograniczone przewidywanie przyszłych nagród (model temporal difference reward).

## Wyuczona bezradność w kontekstach pozaklinicznych

### Edukacja

Uczniowie, którzy wielokrotnie napotykają porażki i nie rozumieją, jak je naprawić, mogą rozwinąć wyuczoną bezradność w kontekście szkolnym:

- rezygnacja z prób rozwiązywania zadań;
- niskie poczucie własnej skuteczności akademickiej;
- unikanie wyzwań i nowych zadań.

**Konsekwencje dla nauczycieli:** Kluczowe jest oferowanie zadań o stopniowanej trudności, dostarczanie informacji zwrotnej skupionej na procesie (a nie zdolnościach wrodzonych) i modelowanie radzenia sobie z niepowodzeniem (ang. *growth mindset*, Dweck).

### Organizacje i miejsca pracy

W kontekście zawodowym wyuczona bezradność może powstawać, gdy pracownicy:

- wielokrotnie widzą, że ich inicjatywy są ignorowane lub karane;
- doświadczają mobbingu lub nadmiernej kontroli;
- pracują w środowiskach o niskiej przewidywalności i sprawiedliwości.

Efektem jest **wypalenie zawodowe** i niska motywacja, nawet przy zmianie warunków na lepsze.

### Wiktymizacja i przemoc partnerska

Wyuczona bezradność jest kluczowym mechanizmem tłumaczącym, dlaczego ofiary przemocy partnerskiej nie odchodzą od sprawcy:

- wieloletnie doświadczenie nieskuteczności podejmowanych prób ucieczki lub obrony;
- przekonanie, że żadne działanie nie zmieni sytuacji;
- utrata wiary w dostępność zewnętrznego wsparcia.

Interwencje terapeutyczne muszą aktywnie odbudowywać **poczucie sprawczości** (ang. *self-efficacy*) i weryfikować przekonanie o nieskuteczności działań.
...
### Kwestionariusz Stylu Atrybucji (ASQ)
...
ACT nie stara się bezpośrednio modyfikować treści atrybucji, lecz:

- uczy akceptacji trudnych doświadczeń bez walki i unikania;
- wzmacnia **wartości** jako źródło sprawczości niezależne od wyniku działania;
- buduje **psychologiczną elastyczność** jako ochronę przed uogólnioną bezradnością.

### Trening optymizmu i rezyliencji
...
Badania na modelach zwierzęcych i kliniczne wskazują na skuteczność **SSRI** w przerywaniu cyklu bezradności. Mechanizm serotoninnowy leżący u podstaw bezradności sugeruje, że leki serotoninergiczne działają nie tylko objawowo, ale i mechanistycznie na substrat wyuczonej bezradności.
