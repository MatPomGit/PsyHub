...
Systematyczne przeglądy badań (Dube i wsp., 2009; Stojanovich, 2010) pokazują:

- Niekorzystne doświadczenia dziecięce (ACE) zwiększają ryzyko chorób autoimmunologicznych o 20–100% zależnie od choroby
- Traumatyczne zdarzenia życiowe poprzedzają pierwszy epizod wielu chorób autoimmunologicznych
- Kobiety z PTSD mają wyższy wskaźnik chorób autoimmunologicznych

Mechanizm: dysregulacja osi HPA po traumie → zaburzona ochronna funkcja kortyzolu → brak hamowania odpowiedzi zapalnej.
...
- Ból, zmęczenie i niepełnosprawność nasilają depresję i lęk
- Lęk i depresja są niezależnymi predyktorami gorszego funkcjonowania, nie tylko aktywności choroby

**Stres a zaostrzenia:** Badania dzienniczkowe (ecological momentary assessment) potwierdzają, że stresujące zdarzenia poprzedzają zaostrzenia RZS o 24–72 h. Mechanizm: stres → prostaglandyny i cytokiny prozapalne.

**Terapia:** CBT, programy redukcji stresu i leczenie depresji poprawiają jakość życia, radzenie sobie z bólem i adherencję niezależnie od farmakoterapii.
...
**Hashimoto:** Autoimmunologiczne niedoczynność tarczycy. Stres może być wyzwalaczem lub czynnikiem nasilającym. Depresja jest częsta i może wynikać zarówno z hipotyreozy, jak i niezależnie.

**Choroba Gravesa-Basedowa:** Klasycznie obserwowana jako rozwijająca się po silnym urazie psychicznym. Hiperkortyzolemia i aktywacja współczulna mogą stymulować receptory TSH lub modyfikować prezentację antygenów.
