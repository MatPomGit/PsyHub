...
Diagnoza psychosomatyczna to wielowymiarowy proces oceny, który integruje perspektywę biologiczną, psychologiczną i społeczną. Jej celem jest nie tylko wykluczenie organicznej przyczyny objawów, lecz aktywne rozumienie, jak czynniki psychiczne i kontekst życiowy przyczyniają się do dolegliwości pacjenta.

## Zasady podejścia diagnostycznego

### Od „albo–albo" do „i–i"
Tradycyjnie lekarze szukali: czy objawy mają przyczynę organiczną, *czy* psychiczną. Psychosomatyka proponuje inne pytanie: *w jaki sposób* biologia i psychika wzajemnie na siebie wpływają w tym konkretnym przypadku?

> Przykład: Pacjentka z bólami brzucha ma IBS (organiczne) ORAZ historię traumy seksualnej (psychologiczne). Oba wymiary są prawdziwe i oba wymagają leczenia.

### Walidacja doświadczenia pacjenta
Pierwszym krokiem jest wyraźne zakomunikowanie, że dolegliwości pacjenta są traktowane poważnie, niezależnie od tego, czy wyniki badań są prawidłowe. Brak potwierdzenia organicznego nie oznacza, że ból lub zmęczenie nie istnieje.

## Wywiad psychosomatyczny

Skuteczny wywiad psychosomatyczny obejmuje:

**Kontekst życiowy objawów:**
- Kiedy po raz pierwszy pojawiły się objawy?
- Co działo się w życiu pacjenta w tamtym czasie (stres, straty, zmiany)?
- Co nasila i co łagodzi objawy?
...
- Aktywność fizyczna, dieta, używanie substancji
- Adherencja do poprzednich terapii
- Stosunek do medycyny (zaufanie/nieufność)

## Narzędzia przesiewowe

| Narzędzie | Co mierzy | Kontekst |
|---|---|---|
| PHQ-15 | Somatyczne objawy somatyzacji | Podstawowa opieka zdrowotna |
| PHQ-9 | Depresja | Ogólny skrining |
| GAD-7 | Lęk uogólniony | Ogólny skrining |
| TAS-20 | Aleksytymia | Badania kliniczne i diagnoza |
| SOMS-7 | Zaburzenia somatyczne (ICD) | Specjalistyczna diagnostyka |
| ACE questionnaire | Niekorzystne doświadczenia dziecięce | Wywiad traum |
| SF-36 / WHOQOL | Jakość życia | Ocena funkcjonowania |
...
- Wiele niespecyficznych objawów z różnych układów
- Wyniki badań nieadekwatne do nasilenia objawów
- Częste wizyty, niska satysfakcja z leczenia
- Historia wielu specjalistów bez diagnozy
