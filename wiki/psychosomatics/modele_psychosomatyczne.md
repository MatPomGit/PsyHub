...
Franz Alexander zakładał, że każda choroba psychosomatyczna wynika z **określonego, nieświadomego konfliktu emocjonalnego**. Konflikt prowadzi do chronicznego pobudzenia autonomicznego układu nerwowego, które z czasem uszkadza konkretny narząd.

**Krytyka:** Spekulatywność, brak kontrolnych grup, niemożność falsyfikacji. Badania empiryczne nie potwierdziły specyficznych profili osobowości dla poszczególnych chorób.
...
## 3. Model biopsychospołeczny (Engel, 1977)

George Engel zaproponował trójpoziomowe spojrzenie:

```
BIOLOGICZNY   ← geny, neurobiologia, fizjologia
PSYCHOLOGICZNY ← emocje, poznanie, osobowość, historia
SPOŁECZNY     ← relacje, kultura, środowisko, dostęp do opieki
```

Choroba jest wypadkową interakcji wszystkich trzech poziomów. Model ten jest dziś **standardem opieki psychosomatycznej** i stanowi fundament psychiatrii konsultacyjnej.

> **Przykład:** Zawał serca = predyspozycje genetyczne (bio) + wrogość, pośpiech (psycho) + praca pod presją, izolacja (społ.)
...
Oś HPA (podwzgórze–przysadka–nadnercza) i oś SAM (współczulna–rdzeniowa) to główne drogi, którymi mózg mówi do ciała w sytuacji stresu. Kortyzol i katecholaminy wpływają na immunologię, metabolizm i układ sercowo-naczyniowy.

Zidentyfikowane szlaki:

- **Stres → kortyzol → immunosupresja → podatność na infekcje i nowotwory**
- **Stres → stan zapalny (IL-6, TNF-α) → depresja, choroby autoimmunologiczne**
- **Stres → dysbioza jelitowa → oś jelito–mózg → nastrój, odporność**

## 6. Model regulacji afektu i ciała (Damasio, van der Kolk)
...
> **Podsumowanie:** Modele psychosomatyczne ewoluowały od redukcjonistycznej specyficzności ku coraz bardziej złożonym, systemowym ujęciom, w których choroba jest zawsze wypadkową biologii, psychiki i kontekstu społecznego.
