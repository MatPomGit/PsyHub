...
- 25–35% wizyt u lekarzy POZ zawiera dolegliwości somatyczne bez organicznego podłoża
- Pełne zaburzenia somatyczne dotyczą 5–10% populacji
- Koszty diagnostyczne są wielokrotnie wyższe niż u porównywalnych pacjentów bez somatyzacji

## Klasyfikacja (DSM-5 i ICD-11)

### Zaburzenie objawów somatycznych (SSD, DSM-5)
Kluczowe kryterium: **nieproporcjonalne i trwałe myśli, uczucia lub zachowania** związane z objawami somatycznymi (nie brak organicznej przyczyny). Objawy mogą mieć lub nie mieć podłoża medycznego.

Trzy komponenty „myśli, uczuć, zachowań":

- katastrofizacja na temat poważności objawów
- wysoki poziom lęku zdrowotnego
- nadmierne poświęcanie czasu na objawy / szukanie pomocy
...
- Bóle: głowy, pleców, brzucha, miednicy, kończyn
- Objawy ze strony układu pokarmowego: nudności, wzdęcia, zaparcia, biegunki (nakładające się z IBS)
- Zmęczenie, osłabienie, „ciężkość" kończyn
- Kołatanie serca, duszność bez tła kardiologicznego
- Parestezje (mrowienie, drętwienie)
- Zawroty głowy, omdlenia

## Diagnoza różnicowa

Niezbędne jest wykluczenie chorób organicznych, szczególnie:

- niedobory witaminowe (B12, D), niedoczynność tarczycy
- choroby autoimmunologiczne o zmiennym przebiegu
- fibromialgia (nakłada się z somatyzacją)
- wczesne etapy SM, choroby neurologiczne
