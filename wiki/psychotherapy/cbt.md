...
**Aaron Beck** (1963) opracował model poznawczy depresji, obserwując charakterystyczne wzorce myślenia u pacjentów. Centralnym pojęciem jest **triada poznawcza**: negatywne przekonania o sobie (*„jestem bezwartościowy"*), świecie (*„świat jest okrutny"*) i przyszłości (*„nic się nie zmieni"*). Przekonania te filtrują doświadczenia przez **zniekształcenia poznawcze**.

> **Automatyczne myśli** to szybkie, mimowolne myśli pojawiające się w odpowiedzi na sytuacje. Są powierzchniowym poziomem poznawczym, poniżej którego leżą **przekonania pośredniczące** (zasady, założenia) i **przekonania rdzenne** (*core beliefs*) o sobie, innych i świecie.
...
CBT ma **najsilniejsze dowody spośród wszystkich form psychoterapii** dla: depresji, zaburzeń lękowych (GAD, fobia społeczna, lęk napadowy, PTSD), OCD, zaburzeń odżywiania i bezsenności (CBT-I). Jest ujęta jako leczenie pierwszego wyboru w wytycznych NICE, APA i PTD.
