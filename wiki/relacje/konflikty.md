# Konflikty i ich rozwiązywanie w związkach
...
## Źródła konfliktów w parach

Konflikty w związkach romantycznych wynikają z wielu nakładających się źródeł:

### Różnice w potrzebach i wartościach
- Odmienne priorytety (kariera vs. rodzina, autonomia vs. bliskość)
- Różne wartości religijne, polityczne lub moralne
- Rozbieżne wizje ról płciowych i podziału obowiązków

### Deficyty komunikacyjne
- Błędna interpretacja intencji partnera
- Nieumiejętność wyrażania potrzeb bez oskarżeń
- Wzorzec żądanie–wycofanie (*demand-withdraw pattern*)

### Czynniki zewnętrzne i sytuacyjne
- Stres zawodowy, finansowy lub zdrowotny przenoszony na relację
- Wchodzenie w nowe role (rodzicielstwo, opieka nad rodzicem)
- Zmiany życiowe (przeprowadzka, zmiana pracy)

---

## Konstruktywny vs. destrukcyjny styl konfliktu

| Wymiar | Konstruktywny | Destrukcyjny |
|---|---|---|
| **Cel** | rozwiązanie problemu lub wzajemne zrozumienie | „wygranie" kłótni, ukaranie partnera |
| **Komunikat** | skupiony na zachowaniu i uczuciach | atak na osobowość, generalizacje |
| **Słuchanie** | aktywne, z potwierdzeniem | przerywanie, obrona, kontratak |
| **Emocje** | regulowane, wyrażane autentycznie | niekontrolowane lub tłumione |
| **Wynik** | porozumienie lub akceptacja różnic | eskalacja, uraza, zamrożenie relacji |
| **Granice** | zakres tematu określony | grzebanie przeszłości, nieistotne zarzuty |

---

## Model stylów konfliktowych Thomas-Kilmann

Kenneth Thomas i Ralph Kilmann (1974) opracowali model opisujący **pięć stylów zarządzania konfliktem** na dwóch osiach: asertywność (dbanie o własne interesy) i kooperatywność (dbanie o interesy drugiej strony):

| Styl | Asertywność | Kooperatywność | Zastosowanie |
|---|:---:|:---:|---|
| **Rywalizacja** | wysoka | niska | sytuacje kryzysowe wymagające szybkich decyzji |
| **Kolaboracja** | wysoka | wysoka | złożone problemy wymagające twórczych rozwiązań |
| **Kompromis** | średnia | średnia | tymczasowe rozwiązania przy ograniczonym czasie |
| **Unikanie** | niska | niska | błahe sprawy; czas na ochłonięcie |
| **Dostosowanie** | niska | wysoka | gdy sprawa jest ważniejsza dla partnera |

W kontekście relacji par **kolaboracja** jest najbardziej adaptacyjna długoterminowo; nadużywanie **unikania** prowadzi do kumulowania uraz i wybuchów, a **rywalizacja** niszczy poczucie bezpieczeństwa i równości.
...
**Demand-withdraw pattern** (Christensen & Heavey, 1990) jest jednym z najlepiej udokumentowanych destrukcyjnych wzorców w konflikcie par:
...
| Koncepcja | Autor(zy) | Implikacja praktyczna |
|---|---|---|
| 69% problemów nierozwiązywalnych | Gottman (1999) | celem jest dialog, nie rozwiązanie |
| Model TKI | Thomas & Kilmann (1974) | kolaboracja jako optymalny styl |
| Flooding | Gottman (1994) | 20-min przerwa przed powrotem do rozmowy |
