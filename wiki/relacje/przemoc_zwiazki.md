# Przemoc w związkach intymnych (IPV)
...
## Rodzaje przemocy w związkach

| Typ przemocy | Opis | Przykłady |
|---|---|---|
| **Fizyczna** | działania powodujące ból, uraz lub uszkodzenie ciała | uderzenia, kopanie, duszenie, użycie przedmiotów |
| **Seksualna** | każdy kontakt seksualny bez zgody lub pod przymusem | gwałt małżeński, wymuszanie aktów seksualnych, upokorzenia seksualne |
| **Emocjonalna/psychologiczna** | zachowania naruszające poczucie własnej wartości i autonomii | poniżanie, izolacja, groźby, kontrola, gaslighting |
| **Ekonomiczna** | kontrolowanie dostępu do zasobów finansowych | odbieranie dokumentów, zakaz pracy, kontrola wydatków |
| **Cyfrowa** | wykorzystanie technologii do kontroli i nękania | śledzenie lokalizacji, szpiegowanie komunikacji, cyberstalking |
...
Michael Johnson (1995, 2008) wprowadził kluczowe rozróżnienie między:

| Typ | Charakterystyka | Sprawca | Dynamika |
|---|---|---|---|
| **Terroryzm intymny** (*Intimate Terrorism*) | systematyczna kontrola i dominacja; eskalacja | głównie mężczyźni w związkach heteroseksualnych | jednostronna, ukierunkowana na władzę |
| **Sytuacyjna przemoc w parze** (*Situational Couple Violence*) | sporadyczne incydenty eskalacji podczas konfliktu | oboje partnerzy | obustronna, nie jest ukierunkowana na kontrolę |
| **Gwałtowny opór** (*Violent Resistance*) | przemoc jako obrona przed terroryzmem intymnym | głównie kobiety | reaktywna |
| **Wzajemna przemocowa kontrola** | oboje partnerzy dążą do dominacji | oboje | rzadka |

Rozróżnienie Johnsona ma istotne implikacje praktyczne: **terapia par jest contraindicated w terroryzmie intymnym**, natomiast może być skuteczna w sytuacyjnej przemocy w parze przy zapewnieniu bezpieczeństwa.
...
- doświadczenie przemocy w rodzinie pochodzenia (model uczenia się)
- alkohol i substancje psychoaktywne (2–3× wyższe ryzyko incydentów)
- zaburzenia osobowości (szczególnie antyspołeczne, borderline)
- niskie poczucie własnej wartości i impulsywność

### Czynniki relacyjne
- wysoki poziom konfliktów i niskie umiejętności komunikacyjne
- nierównowaga władzy (ekonomiczna, statusowa)
- izolacja społeczna pary

### Czynniki społeczno-kulturowe
- akceptacja przemocy jako normalnej metody rozwiązywania konfliktów
- patriarchalne normy dotyczące ról płciowych
- ubóstwo i bezrobocie

---

## Trauma więzi (*Trauma Bonding*)
...
## Psychologiczne konsekwencje dla ofiar

| Obszar | Konsekwencje |
|---|---|
| **PTSD** | intruzje, unikanie, hiperpobudzenie, dysocjacja |
| **Depresja** | anhedonia, myśli suicydalne, niska samoocena |
| **Lęk** | zaburzenia lękowe uogólnione, fobie specyficzne |
| **Tożsamość** | zaburzenia obrazu siebie, poczucie beznadziei |
| **Somatyczne** | przewlekły ból, zaburzenia somatyzacyjne, choroby autoimmunologiczne |
| **Społeczne** | izolacja, trudności z zaufaniem, unikanie relacji |
...
| Koncepcja | Autor(zy) | Kluczowy wkład |
|---|---|---|
| Cykl przemocy | Walker (1979) | czterofazowy model dynamiki IPV |
| Typologia IPV | Johnson (1995) | rozróżnienie terroryzmu intymnego i przemocy sytuacyjnej |
