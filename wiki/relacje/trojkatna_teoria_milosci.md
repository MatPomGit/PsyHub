...
Intymność odnosi się do poczucia bliskości, połączenia i więzi w relacji miłosnej. Obejmuje:
- wzajemne zrozumienie i troskę
- dzielenie się doświadczeniami i wartościami
...
## Siedem typów miłości

Różne konfiguracje trzech składników tworzą siedem typów miłości:
...
- Dysproporcje między składnikami u partnerów wiążą się z niższą jakością relacji (*Lemieux & Hale, 1999*).
- Namiętność spada najszybciej w miarę trwania związku, podczas gdy intymność i zobowiązanie mogą wzrastać (*Acker & Davis, 1992*).

---

## Zastosowanie do etapów związku

| Etap związku | Dominujące składniki | Wyzwania |
|---|---|---|
| Zakochanie (0–2 lata) | namiętność > intymność | habituacja namiętności, idealizacja partnera |
| Budowanie więzi (2–7 lat) | intymność, zobowiązanie | konflikty wartości, korekta idealnego obrazu partnera |
| Dojrzały związek (7+ lat) | zobowiązanie, intymność | utrzymanie namiętności, zapobieganie rutynie |
| Kryzys pary | wahania wszystkich składników | zmiana proporcji jako sygnał interwencji |
...
| Styl | Nazwa łacińska | Charakterystyka |
|---|---|---|
| Eros | miłość namiętna | intensywna, fizyczna, romantyczna |
| Ludus | miłość zabawna | gra, wielość partnerów, brak zobowiązania |
| Storge | miłość przyjacielska | powolny rozwój z przyjaźni |
| Pragma | miłość praktyczna | racjonalny dobór partnera |
| Mania | miłość obsesyjna | zazdrość, lęk, emocjonalna zależność |
| Agape | miłość altruistyczna | bezinteresowna troska o dobro partnera |

---

## Różnice kulturowe

Badania międzykulturowe wskazują na istotne różnice w przeżywaniu i definiowaniu miłości:
...
| Składnik | Charakter | Trajektoria w związku | Neurobiologiczny korelat |
|---|---|---|---|
| Intymność | emocjonalny | wolno rosnąca, stabilizuje się | oksytocyna, wazopresyna |
...
- Lee, J. A. (1973). *The Colors of Love*. New Press.
- Lemieux, R., & Hale, J. L. (1999). Intimacy, passion and commitment in young romantic relationships. *Psychological Reports, 85*(2), 497–503.
