...
## Myślenie operacji konkretnych (Piaget)

Przejście z myślenia przedoperacyjnego do operacji konkretnych to fundamentalna zmiana jakościowa. Dziecko zdobywa kilka kluczowych zdolności:

| Zdolność | Opis | Klasyczne zadanie Piageta |
|---|---|---|
| **Zachowanie stałości** | rozumienie, że ilość nie zmienia się mimo zmiany kształtu/ułożenia | przelanie wody między różnymi naczyniami |
| **Odwracalność** | operacja może być mentalnie cofnięta | a + b = c, więc c – b = a |
| **Decentracja** | uwzględnianie wielu wymiarów jednocześnie | klasyfikacja obiektów wg koloru i kształtu |
...
## Strefa najbliższego rozwoju w kontekście szkolnym
...
3. Utrzymywanie kierunku działania
4. Wskazywanie krytycznych elementów
5. Kontrolowanie frustracji
6. Modelowanie rozwiązania

Wycofywanie rusztowania, gdy dziecko jest gotowe do samodzielności, jest kluczowe dla internalizacji strategii.
...
## Relacje rówieśnicze i grupy społeczne

W wieku szkolnym rówieśnicy zyskują rosnące znaczenie jako źródła porównań społecznych, wsparcia i norm. Selman (1980) opisał stadia rozumienia perspektywy innych:

| Stadium | Wiek (orientacyjnie) | Charakterystyka |
|---|---|---|
| 0 – egocentryczne | 3–6 lat | nierozróżnianie własnej i cudzej perspektywy |
| 1 – subiektywne | 6–8 lat | rozumienie, że inni mają inne myśli, ale nie powiązanie z intencjami |
| 2 – samorefleksyjne | 8–10 lat | zdolność patrzenia na siebie oczami innego |
...
## Rozwój pojęcia „ja" i samoocena

Dzieci w średnim dzieciństwie przechodzą od opisywania siebie przez cechy zewnętrzne i konkretne działania do używania cech psychologicznych i porównań społecznych.

**Porównania społeczne** (Festinger, 1954) stają się dominującym mechanizmem oceny własnej kompetencji. Dziecko pyta: „Czy jestem lepszy/gorszy od innych?" zamiast pytać: „Czy mi się udało?".

Harter (1982) wyróżniła **pięć domen samooceny** w wieku szkolnym:

- Kompetencja poznawcza (akademicka)
- Akceptacja rówieśnicza
- Sprawność sportowa
- Wygląd zewnętrzny
- Zachowanie (przestrzeganie norm)

**Samoocena globalna** jest w tym modelu odrębnym konstruktem, powiązanym z rozbieżnością między „ja realnym" a „ja idealnym".
...
Deficyty ToM wiążą się ze spektrum autyzmu (Baron-Cohen, 1995) oraz trudnościami w relacjach rówieśniczych.
...
- Deficyt świadomości fonologicznej (przetwarzanie dźwięków mowy)
- Deficyt szybkości nazywania (rapid automatized naming, RAN)
