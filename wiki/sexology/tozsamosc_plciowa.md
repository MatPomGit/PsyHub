...
**Osoba transpłciowa** (*transgender*) to ktoś, kogo tożsamość płciowa różni się od płci przypisanej przy urodzeniu. **Osoba transseksualna** tradycyjnie oznaczała dążenie do tranzycji medycznej (hormonalnej i/lub chirurgicznej), ale termin jest stopniowo zastępowany przez transpłciowy jako szerszy i mniej medykalizujący. **Niebinarne** (*non-binary, genderqueer, genderfluid*) tożsamości wykraczają poza dychotomię kobieta/mężczyzna.
...
Podejście **gender-affirming** opiera się na akceptacji i wspieraniu tożsamości płciowej, nie na próbach jej zmiany. Interwencje medyczne (hormonalna terapia zastępcza, chirurgia potwierdzająca płeć) przy odpowiedniej kwalifikacji redukują dysforię i poprawiają zdrowie psychiczne. Opieka psychologiczna skupia się na wsparciu tranzycji, radzeniu sobie ze stygmatyzacją i zarządzaniu relacjami rodzinnymi.
