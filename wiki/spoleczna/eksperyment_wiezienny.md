...
W podziemiach Wydziału Psychologii Stanford'u urządzono prowizoryczne więzienie:

- Cele urządzono w zwykłych salach laboratoryjnych; drzwi zablokowano prętami
- Więźniom nadano **numery** zamiast imion, przydzielono kombinezony i łańcuszki na kostki
- Strażnicy otrzymali mundury, pałki i ciemne okulary (by ukryć oczy i wzmocnić anonimowość)
- Zimbardo sam przyjął rolę „superintendenta więzienia"
...
- Pozbawianie posiłków i praw do korzystania z toalety
- Nocne „apele" (celowe budzenie więźniów)
- Zmuszanie do upokarzających czynności (m.in. czyszczenie sedesów gołymi rękami)
- Werbalne poniżanie, drwiny, krzyki

### Dni 3–5: Załamanie emocjonalne więźniów

Kilku uczestników zaczęło przejawiać objawy **poważnego kryzysu psychicznego**:

- Płacz, napady lęku, dezorientacja
- Objawy depresyjne i somatyczne (wysypki, psychosomatyczne bóle brzucha)
...
## Główne wnioski i interpretacje
...
Czynniki sytuacyjne, które Zimbardo uznał za kluczowe:

| Mechanizm | Opis |
|-----------|------|
| **Deindywiduacja** | Utrata poczucia własnej tożsamości przez mundur, numer i anonimowość |
...
SPE jest często zestawiany z **eksperymentami Stanleya Milgrama** (1961–1963), w których badani aplikowali pozorne wstrząsy elektryczne na polecenie autorytetu:

| Aspekt | Milgram | Zimbardo (SPE) |
|--------|---------|----------------|
| Rodzaj zachowania | Posłuszeństwo wobec autorytetu | Spontaniczne przyjęcie roli |
| Źródło presji | Zewnętrzny autorytet (eksperymentator) | Wewnętrzna dynamika grupy i rola |
| Czas trwania | Jednorazowe sesje | Kilkudniowy proces |
| Wniosek | Posłuszeństwo wobec autorytetu | Siła roli i sytuacji |

---

## Kontrowersje i krytyka metodologiczna
...
Haslam i Reicher przeprowadzili bardziej kontrolowany eksperyment więzienny dla BBC (2002). Ich wnioski były zasadniczo odmienne:

- Uczestnicy **nie internalizowali automatycznie** narzuconych ról
- Okrucieństwo wymagało **aktywnego przywódcy** skłaniającego grupę do zachowań opresyjnych
- Teoria tożsamości społecznej (Tajfel, Turner) okazała się lepszą ramą interpretacyjną niż efekt sytuacyjny Zimbardo

### Kwestie etyczne

SPE jest dziś **paradygmatycznym przykładem badania nieetycznego**. Nie mógłby zostać przeprowadzony zgodnie z obowiązującymi standardami:
...
## Wpływ kulturowy i zastosowania

### Abu Ghraib (2003–2004)

Zimbardo był biegłym sądowym w procesach żołnierzy oskarżonych o znęcanie się nad więźniami w Abu Ghraib. Wskazywał, że tortury wynikały ze struktury sytuacyjnej i instytucjonalnej, a nie z patologii jednostek. Sąd odrzucił ten argument jako zbyt deterministyczny.
...
SPE wpłynął na rozumienie dynamiki organizacyjnej, zarządzania instytucjami więziennymi, reformy penitencjarnej i szkoleń dla służb mundurowych. Koncepcja deindywiduacji znalazła zastosowanie w profilaktyce przemocy grupowej, cyberbullingu i psychologii tłumu.

---

## SPE w popkulturze

Eksperyment stanfordzki był wielokrotnie adaptowany:

- **Das Experiment** (film fabularny, Niemcy 2001, reż. Oliver Hirschbiegel)
- **The Experiment** (film fabularny, USA 2010)
- **The Stanford Prison Experiment** (film dokumentalno-fabularny, USA 2015)
- Liczne odcinki seriali dokumentalnych i podcastów o psychologii

Warto pamiętać, że adaptacje filmowe często dramatyzują i upraszczają przebieg eksperymentu.

---

## Refleksje i aktualność
...
|---------|------|
| **Rok** | 1971 |
| **Badacz** | Philip Zimbardo (Stanford University) |
| **Uczestnicy** | 24 studenci (12 strażników, 12 więźniów) |
| **Zaplanowany czas** | 2 tygodnie |
| **Faktyczny czas** | 6 dni |
| **Główny wniosek** | Sytuacja i rola mogą skłonić zwykłych ludzi do okrucieństwa |
